      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className={clsx(
          ...
          isGlass
            ...
            : "bg-lab-ui/40 text-lab-text shadow-lg shadow-paper-shadow"
        )}>
          <UserPlus size={28} />
        </div>
        <h2 className={clsx(
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={clsx(
                    "block w-full pl-12 pr-4 py-4 border-none rounded-2xl leading-5 focus:outline-none transition-all text-sm",
                    isGlass
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className={clsx(
                  ...
                  isGlass ? "bg-transparent text-white/40" : "bg-white text-lab-text/40"
