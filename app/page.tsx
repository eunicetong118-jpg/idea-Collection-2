...
export default function LandingPage() {
  ...
  return (
    <div className={clsx(
      "min-h-screen font-sans relative overflow-hidden transition-colors duration-500",
      isLG2
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-16">
            <header className="space-y-6">
              <div className={clsx(
                ...
                isLG2 ? "lg2-reveal" : (isGlass ? "glass-reveal" : "")
              )}>
                <span className={clsx(
                  "text-[10px] uppercase tracking-[0.5em] font-black",
                  isLG2 ? "text-slate-400" : (isGlass ? "text-white/40" : "opacity-40")
                )}>
                  PROTOCOL : {isLG2 ? 'LIQUID_GLASS_v2.0' : (isGlass ? 'GLASS_v1.0' : 'WASHI_v2.1')}
                </span>
                <div className={clsx(
                  "h-[1px] w-16",
                  isLG2 ? "bg-slate-200" : (isGlass ? "bg-white/40" : "bg-lab-ui/40")
                )} />
              </div>
              <div className="relative inline-block">
                <h1 className={clsx(
                  "text-7xl md:text-9xl font-bold tracking-tighter leading-[0.85] ink-reveal [animation-delay:200ms]",
                  isLG2 ? "text-slate-800 lg2-reveal" : (isGlass ? "text-white glass-reveal" : "text-lab-text")
                )}>
                  Idea <br />
                  <span className={clsx(
                    "italic pr-4",
                    isLG2
                      ? "text-teal-500"
                      : (isGlass ? "text-glass-secondary" : "text-lab-ui")
              ...
              <p className={clsx(
                ...
                isLG2
                  ? "text-slate-500 lg2-reveal"
                  : (isGlass ? "text-white/70 glass-reveal" : "text-lab-text/70")
              )}>
            ...
            <div className={clsx(
              ...
              <button
                ...
                className={clsx(
                  ...
                  isLG2
                    ...
                    : (isGlass ? "glass-button text-white" : "bg-lab-text text-lab-bg hover:bg-lab-ui hover:text-lab-text shadow-paper-shadow")
                )}
              >
              ...
              <button
                ...
                className={clsx(
                  ...
                  isLG2
                    ? "lg2-glass-bubble text-slate-700 hover:text-slate-900"
                    : (isGlass ? "glass-button-secondary text-white" : "bg-lab-ui text-lab-bg hover:bg-lab-text hover:text-lab-bg shadow-paper-shadow")
                )}
              >
            ...
            {status === "authenticated" && subTopics.length === 0 && !(session?.user as LabUser)?.isAdmin && (
              <div className={clsx(
                ...
                isLG2
                  ? "lg2-glass-bubble text-slate-500"
                  : (isGlass ? "glass-card text-white/80" : "bg-lab-ui/10 border border-lab-ui/20 text-lab-text/60")
              )}>
          ...
          <div className={clsx(
            ...
            isLG2 ? "lg2-reveal [animation-delay:800ms]" : (isGlass ? "glass-reveal [animation-delay:800ms]" : "ink-reveal [animation-delay:800ms]")
          )}>
            <HeroAnimation />
          </div>
        </div>
      ...
      <footer className={clsx(
        ...
        isLG2 ? "border-slate-100" : "border-white/10"
      )}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className={clsx(
            ...
            © 2026 {theme.title} // {isLG2 ? 'Liquid Glass Edition' : (isGlass ? 'Glass Edition' : 'Washi Edition')}
          </div>
          <div className="flex gap-8">
            ...
            <div className={clsx(
              ...
              <div className={clsx(
                ...
                isLG2 ? "bg-teal-500/50" : (isGlass ? "bg-glass-secondary/50" : "bg-lab-ui/50")
              )} />
              Latency: 24ms
            </div>
          </div>
